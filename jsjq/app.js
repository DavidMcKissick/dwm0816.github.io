...
$('#menulist').append(' | ')
$('#menulist').append('<x id="menuitem"><a href="https://www.gofundme.com/skybrook-foundation-for-sarcoidosis">Donate</a></x>')
// $('#menulist').append(' | ')
// $('#menulist').append('<x id="menuitem"><a href="members.html">Membership</a>','</x>')
$('.mainmenu').append('</ul>')
$('.menu').append('</div>')
$('.header').append('</div>')
